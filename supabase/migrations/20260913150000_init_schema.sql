...
insert into public.films (
  ...
  ('11111111-1111-1111-1111-111111111111', 'Amazónia Viva', 'amaz-nia-viva', 2023, 'Natureza', 14.90, '58 min', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?auto=format&fit=crop&w=1800&q=90', 'A força da floresta através de quem a protege todos os dias.', 'A floresta é feita de muitas vozes. Amazónia Viva acompanha quem vive, trabalha e luta pela sua preservação, revelando uma relação profunda entre território, comunidade e futuro.', true),
  ('11111111-1111-1111-1111-111111111111', 'Última Chamada', 'última-chamada', 2022, 'Sociedade', 9.90, '49 min', 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=1800&q=90', 'Retrato de uma geração que resiste ao silêncio e à indiferença.', 'Entre a urgência e a esperança, Última Chamada dá voz a uma geração que decidiu não ficar em silêncio. Histórias de resistência, amizade e mudança contadas por quem está a construir o seu próprio caminho.', true),
